...
//    void resetSubfigureOptimizer();
    ...
    // compute linking structure of 2d srep
    void computeLinkingStructure();

    // read in selected link ids and show them only
    void showSelectedLinks(const char* filename);

    // compute correspondence through entropy
    void computeGeoEntropy();
	...
	// jared
	bool binaryPabloSRepNormalAdjustments();
	//dibyendu
