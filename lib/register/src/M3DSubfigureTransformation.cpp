...
void M3DSubfigureTransformation::getSurfacePointAndNormal(
	Pointlist_server2* pList2, Vector3D & point, Vector3D & normal, double u, double v, double t)
{
    //ThallCode::DbVector3 dbPoint, dbNormal;
	Bpoint bpoint;
