...
enum bpTune_t
{
	...
	//Chong
	BpAtomEndSpokeDirectionalConsistency, // End atoms direction consistensy 
...
//	AtomElongationFactor,	// Elongation factor (in atom stage???)
	...
	SRepDoNormalAdjustments, // Apply initial adjustments to spokes to better approximate orthogonality
