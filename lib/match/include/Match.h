...
//        const char * maskFilename, bool useWindowing = true);
    ...
    void doSpokeNormalAdjustment( M3DObject * targetObject, int figureId, int atomId, int spokeId, int subdivLevel );
...
private:
    ...
    void GetCrestSpokes(vtkSmartPointer<vtkSRep> srepfig, int level, vector<M3DSpoke>& spokes, vtkIdType atomId = -1, int spokeId = -1);
