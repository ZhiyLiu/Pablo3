...
bool bpTuning::initialize()
{
	...
	// Chong
	setNext("AESDC", "AtomEndSpokeDirectionalConsistency",     0.5,
			"[0..] atom stage: weight of penalty for end atom spoke directional consistency");
...
//	setNext("SRMC",    "ModelCreasing",                  0.0005,	"[0..] for future use");
	...
	setNext("SRNA", "SRepDoNormalAdjustments", 			  0.0,
				"[0,1] SRep stage: Before doing SRep stage, adjust interior spokes to better match normals");
