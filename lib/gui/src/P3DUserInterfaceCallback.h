...
public:
    ...
    // Show linking structure of 2D srep
    void computeLinkingStructure();

    // Read in result of selected links and show it
    void readSelectedLinks();

    // compute correspondence through minimizing entropy
