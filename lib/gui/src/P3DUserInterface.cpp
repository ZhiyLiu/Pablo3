...
void P3DUserInterface::cb_LinkingStructure_i(Fl_Menu_*, void *)
{
    callback->computeLinkingStructure();
    if(modelView != NULL)
    {
        modelView->update();
    }
}
void P3DUserInterface::cb_LinkingStructure(Fl_Menu_* o, void* v) {
    ((P3DUserInterface*)(o->parent()->user_data()))->cb_LinkingStructure_i(o,v);
}

void P3DUserInterface::cb_ReadSelectedLinks(Fl_Menu_* o, void* v) {
    ((P3DUserInterface*)(o->parent()->user_data()))->cb_ReadSelectedLinks_i(o,v);
}
void P3DUserInterface::cb_ReadSelectedLinks_i(Fl_Menu_*, void *)
{
    callback->readSelectedLinks();
    if(modelView != NULL)
    {
        modelView->update();
    }
...
void P3DUserInterface::cb_GeoEntropy_i(Fl_Menu_*, void *)
{
    callback->computeGeoEntropy();
    if(modelView != NULL)
    {
        modelView->update();
    }
}
void P3DUserInterface::cb_GeoEntropy(Fl_Menu_* o, void* v) {
    ((P3DUserInterface*)(o->parent()->user_data()))->cb_GeoEntropy_i(o,v);
}
...
Fl_Menu_Item P3DUserInterface::menu_menuBar[] = {
 ...
 {"CPNS Deformation...", 0,  (Fl_Callback*)P3DUserInterface::cb_CPNS, 0, 0, FL_NORMAL_LABEL, 0, 12, 0},
  {"Linking Structure", 0,  (Fl_Callback*)P3DUserInterface::cb_LinkingStructure, 0, 0, FL_NORMAL_LABEL, 0, 12, 0},
   {"Read Selected Link IDs", 0,  (Fl_Callback*)P3DUserInterface::cb_ReadSelectedLinks, 0, 0, FL_NORMAL_LABEL, 0, 12, 0},
...
void P3DUserInterface::cb_fastInterpButton_i(Fl_Check_Button*, void*) {
  callback->toggleFastInterp(fastInterpButton->value());
}
void P3DUserInterface::cb_fastInterpButton(Fl_Check_Button* o, void* v) {
  ((P3DUserInterface*)(o->parent()->parent()->parent()->user_data()))->cb_fastInterpButton_i(o,v);
}
  ...
  { movable_Fl_Window* o = displayControlWindow = new movable_Fl_Window(375, 239, "Display Control");
    ...
    { Fl_Tabs* o = displayControlTabs = new Fl_Tabs(5, 5, 473, 208);
      ...
      { Fl_Group* o = displayControlSurfaceTab = new Fl_Group(10, 36, 360, 170, "Surface");
        ...
        { Fl_Check_Button* o = fastInterpButton = new Fl_Check_Button(25, 70, 20, 25, "Fast Interp");
		  o->down_box(FL_EMBOSSED_BOX);
		  o->value(0);
		  o->color(FL_BACKGROUND2_COLOR);
		  o->selection_color((Fl_Color)1);
		  o->labelsize(12);
		  o->callback((Fl_Callback*)cb_fastInterpButton);
		  o->align(FL_ALIGN_RIGHT);
		}
        o->end();
      }
