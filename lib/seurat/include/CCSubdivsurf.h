...
public:
	...
	void glRender(int nivelo, int polyDex, RenderStyle thisstyle=WIREFRAME, double *c=NULL);
	void glRender(int vNum, int fNum, Bpoint2 *vList, PindexList *fList, RenderStyle thisStyle, double *c=NULL);
