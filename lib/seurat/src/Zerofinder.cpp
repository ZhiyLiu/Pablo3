	  ...
	  const DbVector3& n_A, const DbVector3& n_B, const DbVector3& n_C)
{
	...
	if (beta <= alpha && beta <= gamma) {
		double (Zerofinder::*f)(double) = &Zerofinder::T_U0;
		double (Zerofinder::*df)(double) = &Zerofinder::dT_U0;
	...
	if (beta <= alpha && beta <= gamma) {
		double (Zerofinder::*f)(double) = &Zerofinder::T_V1;
		double (Zerofinder::*df)(double) = &Zerofinder::dT_V1;
