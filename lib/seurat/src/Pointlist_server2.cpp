...
//#endif
        ...
        /*glVertex3d(subdivtileset[vcnt].pnt[0] -
            ...
            subdivtileset[vcnt].pnt[2] -
                ...
                */
	glVertex3d(subdivtileset[vcnt].pnt[0], subdivtileset[vcnt].pnt[1], subdivtileset[vcnt].pnt[2]);
	}

	glEnd();
}

void Pointlist_server2::glRenderSubdivTiles(double displacement, M3DFigure* figure, int fastInterp)
{
//#ifdef COLOR_DEBUG
	double u, v, t;
...
//#endif
	  ...
	  else
	  {
	    if (t == 1)
	    {
	    	Vector3D newB = figure->getInterpolatedBoundaryPoint(v, u, 0);
			glVertex3d(newB.getX(), newB.getY(), newB.getZ());
	    }
	    else if (t == -1)
	    {
	    	Vector3D newB = figure->getInterpolatedBoundaryPoint(v, u, 1);
			glVertex3d(newB.getX(), newB.getY(), newB.getZ());
	    }
	    else
	    {
