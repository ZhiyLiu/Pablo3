...
public:
	...
	bool setNumBasisVectors (int _numBasisVectors) { numBasisVectors = _numBasisVectors; return true;}
	bool setBasisVectorLength (int _basisVectorLength) { basisVectorLength = _basisVectorLength; return true;}
