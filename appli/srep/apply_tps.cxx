//
// Created by jphong on 6/19/18.
// this is apply_tps given a list of specified points
//
...
int main( int argc, char* argv[] ){
	...
	if( argc != 6 ) {
		...
		std::cerr << argv[0];
		std::cerr << " <Template s-rep, tpsFileName, sourceLandMark, pointList and outputPrefix>";
		std::cerr << std::endl;
		return EXIT_FAILURE;
	}
	...
	std::string id_list_filename = argv[4];
	...
	std::ifstream fin;
	fin.open(id_list_filename.c_str());
